...
switch (shapeProfile){
    // Different strokes for different potential sensor setups
    case 'FiveSensorPrototype1':
        bumpPos = [[20,90],[20,130],[190,95],[330,65],[350,120],[20,10],[180,10],[340,10]];
        var bumpOrderR = [1,0,2,4,3,5,6,7];
        let bumpR = bumpOrderR.map(d=>[bumpPos[d][0],solesOffsetY-bumpPos[d][1]]);
